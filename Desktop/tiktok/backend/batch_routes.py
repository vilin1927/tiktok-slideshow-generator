...
def create_batch_job():
    ...
    try:
        ...
        photo_variations = int(request.form.get('photo_variations', 1))
        text_variations = int(request.form.get('text_variations', 1))

        # Clamp to valid range (1-10)
        photo_variations = max(1, min(10, photo_variations))
        text_variations = max(1, min(10, text_variations))

        log.debug(f"Variations: photo={photo_variations}, text={text_variations}")
        ...
        log.info(f"Created batch: {batch_id}")
