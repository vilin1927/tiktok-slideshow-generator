...
def run_generation(session_id, tiktok_url, folder_name, product_context,
    ...
    try:
        ...
        try:
            scraped = scrape_tiktok_slideshow(tiktok_url, session_scraped)
        ...
        update_progress(session_id, 'complete', 'Done!', 100, {
            ...
            'analysis': result.get('analysis'),  # Include for toggle display
            'stats': {
...
def test_scrape():
    ...
    try:
        ...
        scraped = scrape_tiktok_slideshow(tiktok_url, output_dir)
